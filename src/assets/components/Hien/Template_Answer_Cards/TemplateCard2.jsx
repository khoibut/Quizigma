function TemplateCard2() {
    return(
        <>
            <div className={`p-2 flex flex-col snap-center rounded-3xl bg-yellow-500 h-[50vh] md:w-[38vh] min-w-[30vh] transition ease-in-out duration-300 md:hover:-translate-y-[24vh] hover:-translate-y-[30vh]`}>
