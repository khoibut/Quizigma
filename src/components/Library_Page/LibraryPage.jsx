        ...
        <>
            <div className='w-full h-[100vh] overflow-hidden relative'>
                ...
                <div className='w-full h-full flex'>
                    ...
                    <div className='flex flex-wrap overflow-hidden md:p-5 p-2 w-1 h-full bg-gradient-to-b from-[#40c9ff] to-blue-950 dark:from-[#48365d] dark:to-[rgba(36,27,47,1)] light:from-[#ecf2f4] light:to-[#ccdee8] md:w-fit grow snap-y justify-between'>
