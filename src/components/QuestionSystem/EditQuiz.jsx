        ...
        <>
            ...
            <div className="flex flex-col w-full bg-blue-200 m-2 border-slate-500 rounded-lg md:p-10 lg:w-4/5 h-fit">
                ...
                <div className="gap-2 lg:grid lg:grid-cols-2" >
                    ...
                    <input className="p-3 rounded-xl" type="text" />
                    <label className="mt-3 font-semibold" for="quiz-name">Description</label>
                    <textarea className="p-3 rounded-xl h-full"></textarea>
                    </div>

                    <div className="col-span-2 flex justify-end mt-5 justify-self-center w-2/3 lg:w-full " value="SAVE"><button className="w-full sm:w-fit bg-red-400 rounded-full py-2 px-16 text-white hover:bg-rose-500 hover:scale-105 transition-all">SAVE</button></div>
