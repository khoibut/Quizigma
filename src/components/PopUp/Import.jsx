...
function AddImage( {addButton, imageContainer} ) {
    ...
    return (
        <>  
            <div class="w-full xl:w-auto xl:h-full aspect-square border m-auto border-black rounded-sm p-5 flex flex-col">
                <div class="flex justify-between">
                    <button class="sm:px-20 sm:py-5 px-10 py-2 rounded-full bg-red-400 text-white hover:bg-rose-500 hover:scale-105 transition-all" >CROP</button>
